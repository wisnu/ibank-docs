select * from ibankcore.rekeningtransaksi where status_rekening=3

update ibankcore.rekeningtransaksi where nomor_rekening='0010011666' set status_rekening=1;

update ibankcore.rekeningtransaksi set status_rekening=7 where nomor_rekening='0010011666';


select * from ibankcore.rekeningtransaksi where status_rekening=

commit;

0010011666 -- tidak aktif
0010011682 -- dormant
0010057040   -- aktif
0010011583 -- tutup

SELECT SALDO_CETAK_TERAKHIR FROM ibankcore.REGISTERPASSBOOK rp 
INNER JOIN ibankcore.REGISTERLAYANAN rg ON rp.ID_REGISTER = rg.ID_REGISTER 
WHERE rg.NOMOR_REKENING_LAYANAN='0010011666'
;

select * from ibankcore.rekeningaktivitasnonfin;

update ibankcore.rekeningaktivitasnonfin
set tanggal_aktivitas = TO_TIMESTAMP('2026-03-16 10:00:00', 'YYYY-MM-DD HH24:MI:SS')
;

select * from ibankcore.rekeningaktivitasnonfin
where nomor_rekening='0010011666'
 and tanggal_aktivitas >= TO_TIMESTAMP('2026-03-16 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
 and tanggal_aktivitas < TO_TIMESTAMP('2026-03-16 00:00:00', 'YYYY-MM-DD HH24:MI:SS') + 1
;

select tgl_aktivitas_terakhir from ibankcore.rekeningliabilitas where nomor_rekening='0010011666';

commit;

select * from ibankcore.parameterglobal where kode_parameter='DORM_HARI';
