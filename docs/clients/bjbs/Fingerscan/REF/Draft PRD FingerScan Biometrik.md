# PRD FingerScan Biometrik

![Logo](media/image1.png)

**Dipersiapkan oleh:**

![PT ISI](media/image3.png)
...
| Informasi | Nilai |
|-----------|-------|
| **Nomor Dokumen** | PRD-BJBS-FingerScan-01 |
| **Versi** | 1.0.0 |
| **Tahun** | 2025 |
...
| Nama | Role |
|------|------|
| [Aulia Riefqi Ardana](mailto:auliardana@gmail.com) | |
...
- [List Requirement](#list-requirement)
  - [A. Fungsional (Functional Requirements)](#a-fungsional-functional-requirements)
  - [B. Non-Fungsional (Non-Functional Requirements)](#b-non-fungsional-non-functional-requirements)
  - [C. Integrasi (Integration Requirements)](#c-integrasi-integration-requirements)
  - [D. Keamanan (Security Requirements)](#d-keamanan-security-requirements)
  - [E. Operasional (Operational Requirements)](#e-operasional-operational-requirements)
  - [F. Risiko & Mitigasi (Risk Control Requirements)](#f-risiko--mitigasi-risk-control-requirements)
  - [G. Audit & Logging](#g-audit--logging)
  - [H. Acceptance Criteria](#h-acceptance-criteria)
...
| 06 | Lock Mechanism | Sistem harus mengunci akun setelah 3 kali percobaan verifikasi gagal. Skemanya seperti buka blokir, yang di lock user nya di level fingerprint. |
...
| I-07 | [DAF-Treasury] Treasury > Otorisasi Entri Data | Terhubung dengan proses otorisasi menu Treasury pada modul daf-treasury. |
...
| I-10 | [BDS-CS Teller] Otorisasi Entri Data | Terhubung dengan proses otorisasi di List Otorisasi Entri Data Web BDS untuk teller & CS. |
| I-11 | [BDS-CS Teller] Otorisasi Entri Data | Terhubung dengan proses otorisasi di List Otorisasi Entri Data Web BDS untuk teller & CS. |
...
![Arsitektur Sistem](media/image4.png)
...
> **Catatan:** Station tidak menyimpan data biometrik permanen. Semua hasil dikirim ke server pusat untuk diproses lebih lanjut.

#### 2. Fingerscan Service
...
> **Catatan:** Business Applications hanya memicu dan mengonsumsi hasil verifikasi — tidak menangani proses capture atau matching sidik jari. Semua logika biometrik berada di sisi **Fingerscan Service** dan **Fingerstation**.
